...
export class TodosService {
    ...
    /**
     * Toggle Complete
     * Toggle the is_completed flag of a todo.
     * @param data The data for the request.
     * @param data.id
     * @returns TodoPublic Successful Response
     * @throws ApiError
     */
    public static toggleComplete(data: TodosToggleCompleteData): CancelablePromise<TodosToggleCompleteResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
